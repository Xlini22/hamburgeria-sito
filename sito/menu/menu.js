...
const burgerSlugs=['bourclassic','bourcheese','boursqua','bourcrispy','bouritaly','bourpig','bourvegan','bouregg'];
document.querySelectorAll('.category-burgers .menu-product').forEach((card,index)=>{
  card.tabIndex=0;
  card.setAttribute('role','link');
  const openProduct=()=>location.href=`../panino/panino.html?panino=${burgerSlugs[index]}`;
